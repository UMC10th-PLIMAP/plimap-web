      ...
      <div className="relative flex flex-col pt-[env(safe-area-inset-top)] pb-[calc(env(safe-area-inset-bottom)+108px)]">
        <header className="grid h-[60px] grid-cols-[24px_1fr_24px] items-center px-4">
          ...
          <button
            ...
            aria-label="설정"
            onClick={() => {
              track(AnalyticsEvent.MySettingsClick);
        ...
        <div className="mt-[3px] flex flex-col ">
          <ProfileInfo
            profile={myProfile}
            onFollowingClick={() => {
              track(AnalyticsEvent.MyFollowingClick);
              navigate('/app/my/following');
            }}
            onFollowerClick={() => {
              track(AnalyticsEvent.MyFollowersClick);
            ...
            actions={[
              {
                label: '프로필 편집',
                onClick: () => {
                  track(AnalyticsEvent.MyProfileEditClick);
              ...
              },
              {
                label: '내 PLIMAP',
                onClick: () => {
                  track(AnalyticsEvent.MyPlimapClick);
              ...
              },
              {
                ...
                onClick: () => {
                  ...
                  track(AnalyticsEvent.MyShareClick);
                  setIsShareOpen(true);
                },
                'aria-label': '프로필 공유',
                className: cn(
        ...
        <ProfilePinGrid
          ...
          onPinClick={(pin) => {
            track(AnalyticsEvent.MyPinClick, {
              pin_id: pin.pinId,
          ...
          onRegisterPin={() => {
            track(AnalyticsEvent.MyRegisterPinClick);
            navigate('/app');
          }}
        />
