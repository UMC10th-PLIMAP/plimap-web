...
type ProfileTextAreaFieldProps = Omit<ComponentProps<'textarea'>, 'value' | 'onChange'> & {
  id: string;
  label: string;
  value: string;
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-start gap-[41px]">
        ...
        <div className="flex h-[130px] flex-1 flex-col gap-2 rounded-lg border border-grayscale-1000 p-3">
          <textarea
            id={id}
            value={value}
            ...
            className="body-15-r flex-1 resize-none bg-transparent text-grayscale-100 outline-none placeholder:text-grayscale-700"
            {...textareaProps}
          />
          <span
            className={`etc-13-r shrink-0 self-end ${
