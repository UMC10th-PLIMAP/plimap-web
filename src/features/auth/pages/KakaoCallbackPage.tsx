import { getKakaoAuthCodeFromUrl } from '@/features/auth/utils/kakao';

export default function KakaoCallbackPage() {
  const { code, error } = getKakaoAuthCodeFromUrl(window.location.search);

  // TODO: 백엔드 POST /api/v1/auth/kakao API 준비되면 code 전달하는 로직 추가
  ...
  return (
    <div className="flex h-full min-h-screen flex-col items-center justify-center gap-3 bg-pli-black-100 px-[39px] text-center">
      {error && (
        <>
          <p className="body-18-r text-red">카카오 로그인이 취소되었거나 실패했어요.</p>
